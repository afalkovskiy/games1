...
pygame.display.set_caption('Alex game anim list7')

sprite_sheet_image = pygame.image.load('img/doux4.png').convert_alpha()
sprite_sheet_flame = pygame.image.load('img/flame_24x24.png').convert_alpha()
...
for i in range(animation_steps6):
    animation_list6.append(get_image(sprite_sheet_flame, i, 48, 48, 5, BLACK))
...
while run:
    ...
    screen.blit(animation_list6[frame%5], (xRect,yRect-40))
    ...
    if flag:    
        ...
        screen.blit(img, (x,y))
        # screen.blit(animation_list6[frame%5], (x,y))
        #image = pygame.transform.flip(surface=image, flip_x=True, flip_y=False)
