...
pygame.display.set_caption('Alex game anim list2')
...
while run:
    ...
    if flagRun == True:
        ...
        print("from if flagRun = True:", len(animation_list ), "  frame =", frame)
        animation_cooldown = 100
    if flagRun == False:
        animation_list =  animation_list1
        print("from if flagRun = False:", len(animation_list ), "  frame = ", frame)
        animation_cooldown = 200    
