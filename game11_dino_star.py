...
sound3 = pygame.mixer.Sound('img/superjump-land.wav')   
sound3.set_volume(0.)
...
pygame.display.set_caption('Alex game 11')

sprite_sheet_image = pygame.image.load('img/doux4.png').convert_alpha()
sprite_star_image = pygame.image.load('img/blust3.png').convert_alpha()
...
while run:
    ...
    sound3.play(loops=-1, maxtime=2000)
    ...
    txt1 = "Score: " + str(score) + "  Hits: " + str(nhits)
    draw_text(txt1, text_font, (100,100,100), 10, 10)
    ...
    if current_time - last_update >= animation_cooldown:
        ...
        if abs(x-x1)<50 and abs (y-y1)<50:
            ...
            s1 = 10
            sound1.set_volume(0.0)
            sound3.set_volume(0.8)
            time.sleep(1)

        if y1 > 500 or x1 > 900 or x1 < 0:
            y1 = 0
    ...
    if nhits>2:
        ...
        text_font2 = pygame.font.SysFont(None, 60, bold=True)
        txt1 = "Game over!" 
        draw_text(txt1, text_font2, (100,100,100), 300, 100)
